...
declare type PermissiveTransitionDefinition = Record<string, any>;
 ...
 */
declare type PropertiesKeys = Record<string, string | number | undefined | any>;
/**
 ...
 */
declare type PermissiveMotionProperties = MotionProperties & Record<string, ResolvedSingleTarget>;
/**
 * Variant
 */
...
declare type MotionInstanceBindings<T> = Record<string, MotionInstance<T>>;
...
export { MakeKeyframes as A, TargetWithKeyframes as B, TargetAndTransition as C, TargetResolver as D, EasingFunction as E, CustomValueType as F, MotionValuesMap as G, StopAnimation as H, Inertia as I, Transformer as J, KeyframesTarget as K, Subscriber as L, MotionVariants as M, PassiveEffect as N, Orchestration as O, PermissiveTarget as P, StartAnimation as Q, ResolvedKeyframesTarget as R, StyleProperties as S, TransformProperties as T, UseMotionOptions as U, Variant as V, PropertiesKeys as W, SVGPathProperties as X, Omit as Y, MotionInstance as a, MotionProperties as b, MotionTransitions as c, MotionControls as d, MotionInstanceBindings as e, PermissiveMotionProperties as f, SpringControls as g, Spring as h, MotionTarget as i, MotionPluginOptions as j, ResolvedSingleTarget as k, SingleTarget as l, ResolvedValueTarget as m, ValueTarget as n, Props as o, Easing as p, Repeat as q, Tween as r, Keyframes as s, PopmotionTransitionProps as t, PermissiveTransitionDefinition as u, TransitionDefinition as v, TransitionMap as w, Transition as x, MakeCustomValueType as y, Target as z };

...
function registerEventListeners({ target, state, variants, apply }) {
  ...
  if (_variants.hovered) {
    (0, core_exports.useEventListener)(target, "mouseenter", () => hovered.value = true);
    (0, core_exports.useEventListener)(target, "mouseleave", () => {
      hovered.value = false;
      tapped.value = false;
    });
    (0, core_exports.useEventListener)(target, "mouseout", () => {
      hovered.value = false;
      tapped.value = false;
    });
  }
  if (_variants.tapped) {
    if (supportsMouseEvents()) {
      (0, core_exports.useEventListener)(target, "mousedown", () => tapped.value = true);
      (0, core_exports.useEventListener)(target, "mouseup", () => tapped.value = false);
    }
    if (supportsPointerEvents()) {
      (0, core_exports.useEventListener)(target, "pointerdown", () => tapped.value = true);
      (0, core_exports.useEventListener)(target, "pointerup", () => tapped.value = false);
    }
    if (supportsTouchEvents()) {
      (0, core_exports.useEventListener)(target, "touchstart", () => tapped.value = true);
      (0, core_exports.useEventListener)(target, "touchend", () => tapped.value = false);
    }
  }
  if (_variants.focused) {
    (0, core_exports.useEventListener)(target, "focus", () => focused.value = true);
    (0, core_exports.useEventListener)(target, "blur", () => focused.value = false);
  }
...
function registerVisibilityHooks({ target, variants, variant }) {
  ...
  if (_variants && (_variants.visible || _variants.visibleOnce)) {
    (0, core_exports.useIntersectionObserver)(target, ([{ isIntersecting }]) => {
...
function usePermissiveTarget(target, onTarget) {
  watch(
    () => (0, core_exports.unrefElement)(target),
    (el) => {
      if (!el)
        return;
      onTarget(el);
...
function isMotionInstance(obj) {
  const _obj = obj;
  return _obj.apply !== void 0 && (0, shared_exports.isFunction)(_obj.apply) && _obj.set !== void 0 && (0, shared_exports.isFunction)(_obj.set) && _obj.target !== void 0 && isRef(_obj.target);
}
function useMotions() {
  return motionState;
}

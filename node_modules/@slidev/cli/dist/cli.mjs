...
cli.command(
  ...
  async ({ entry, theme, watch, base, download, out, inspect }) => {
    const { build } = await Promise.resolve().then(() => __toESM(__require("./build-R5LMWNHN.mjs")));
...
cli.command(
  ...
  async ({
    ...
    const { exportSlides } = await Promise.resolve().then(() => __toESM(__require("./export-P5NE27QO.mjs")));
...
cli.command(
  ...
  async ({
    ...
    process.env.NODE_ENV = "production";
    const { exportNotes } = await Promise.resolve().then(() => __toESM(__require("./export-P5NE27QO.mjs")));
    const port = await findFreePort(12445);

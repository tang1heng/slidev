...
import { M as MotionVariants, a as MotionInstance, S as StyleProperties, T as TransformProperties, P as PermissiveTarget, U as UseMotionOptions, b as MotionProperties, c as MotionTransitions, d as MotionControls, e as MotionInstanceBindings, V as Variant, f as PermissiveMotionProperties, g as SpringControls, h as Spring } from './value-8c0ed83e.js';
export { F as CustomValueType, p as Easing, E as EasingFunction, I as Inertia, s as Keyframes, K as KeyframesTarget, y as MakeCustomValueType, A as MakeKeyframes, d as MotionControls, a as MotionInstance, e as MotionInstanceBindings, j as MotionPluginOptions, b as MotionProperties, i as MotionTarget, c as MotionTransitions, G as MotionValuesMap, M as MotionVariants, Y as Omit, O as Orchestration, N as PassiveEffect, f as PermissiveMotionProperties, P as PermissiveTarget, u as PermissiveTransitionDefinition, t as PopmotionTransitionProps, W as PropertiesKeys, o as Props, q as Repeat, R as ResolvedKeyframesTarget, k as ResolvedSingleTarget, m as ResolvedValueTarget, X as SVGPathProperties, l as SingleTarget, h as Spring, g as SpringControls, Q as StartAnimation, H as StopAnimation, S as StyleProperties, L as Subscriber, z as Target, C as TargetAndTransition, D as TargetResolver, B as TargetWithKeyframes, T as TransformProperties, J as Transformer, x as Transition, v as TransitionDefinition, w as TransitionMap, r as Tween, U as UseMotionOptions, n as ValueTarget, V as Variant } from './value-8c0ed83e.js';
...
declare const directive: (variants?: MotionVariants) => Directive<HTMLElement | SVGElement>;
 ...
 */
declare function useMotionControls<T extends MotionVariants>(motionProperties: MotionProperties, variants?: MaybeRef<T>, { motionValues, push, stop }?: MotionTransitions): MotionControls;
...
declare function useMotions(): MotionInstanceBindings<any>;
